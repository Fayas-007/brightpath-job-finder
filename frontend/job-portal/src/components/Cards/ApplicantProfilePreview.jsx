...
const ApplicantProfilePreview = ({
  ...
  const resumeUrl = selectedApplicant.resume || "";
  const resumeName = selectedApplicant.resumeName || "";

  const getDisplayResumeName = (resume, name) => {
    if (name) return name;
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {resumeUrl ? `Download ${getDisplayResumeName(resumeUrl, resumeName)}` : "No resume"}
            </button>
